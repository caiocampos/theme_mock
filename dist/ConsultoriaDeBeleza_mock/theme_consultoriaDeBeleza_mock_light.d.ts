export declare const consultoriaDeBeleza_light_full_theme: {
    borderRadius: {
        none: number;
        small: number;
        medium: number;
...
export declare const consultoriaDeBeleza_light_full_theme_pt: {
    asset: {
        font: {
            file: {
                display: string;
...
//# sourceMappingURL=theme_consultoriaDeBeleza_mock_light.d.ts.map