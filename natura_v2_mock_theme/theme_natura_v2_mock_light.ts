const natura_v2_light_controlls = {
    color:{
        ...
        "primary": "#EB6619", //ok
        "onPrimary": "#000000",
        "primaryLight": "#F29966", //ok
        "onPrimaryLight": "#000000",
        "primaryLightest": "#F8CCB2", //ok
        "onPrimaryLightest": "#000000",
        "primaryDark": "#A0430E", //ok
        "onPrimaryDark": "#FFFFFF",
        "primaryDarkest": "#502207", //ok
        "onPrimaryDarkest": "#FFFFFF",
        "secondary": "#263F30", //ok
        "onSecondary": "#FFFFFF",
        "secondaryLight": "#599471", //ok
        "onSecondaryLight": "#FFFFFF",
        "secondarylightest": "#AACCB7", //ok
        "onSecondarylightest": "#000000",
        "secondaryDark": "#192A20", //ok
        "onSecondaryDark": "#FFFFFF",
        "secondaryDarkest": "#0D1510", //ok
...
export const natura_v2_light_full_theme = 
{
    "borderRadius": {
        "none": 0,
        "small": 2,
    ...
    "alert": {
        "title": {
            ...
            "lineHeight": 1.5,
            "primary": {
                "fontFamily": natura_v2_light_controlls.typography.fontFamily.primary,
                "fontWeight": 500
            },
            "fallback": {
                "fontFamily": natura_v2_light_controlls.typography.fallback.fontFamily,
                "fontWeight": 400
            }
        },
        "content": {
    ...
    "avatar": {
        ...
        "color": {
            "background": natura_v2_light_controlls.color.primary,
            "label": natura_v2_light_controlls.color.highEmphasis
        }
    },
    "badge": {
        "label": {
        ...
        "color": {
            ...
            "secondary": {
                "label": natura_v2_light_controlls.color.highlight,
                "background": natura_v2_light_controlls.color.secondary
            },
            "success": {
                "label": natura_v2_light_controlls.color.onSuccess,
                "background": natura_v2_light_controlls.color.success,
            },
            "alert": {
                "label": natura_v2_light_controlls.color.onAlert,
                "background": natura_v2_light_controlls.color.alert,
            }
        }
    },
    "button": {
        ...
        "contained": {
            "color": {
                ...
                "hover": {
                    "background": natura_v2_light_controlls.color.primaryDark,
                    "border": "#FFFFFF00",
                    "label": natura_v2_light_controlls.color.highEmphasis
                },
                "focus": {
                    "background": natura_v2_light_controlls.color.primaryDarkest,
                    "border": "#FFFFFF00",
                    "label": natura_v2_light_controlls.color.highEmphasis
                }
            }
        ...
        "outlined": {
            "color": {
                "enable": {
                    "background": "#FFFFFF00",
                    "border": natura_v2_light_controlls.color.primary,
                    "label": natura_v2_light_controlls.color.highEmphasis
                },
                "disable": {
                    "background": "#FFFFFF00",
                    "border": natura_v2_light_controlls.color.lowEmphasis,
                    "label": natura_v2_light_controlls.color.mediumEmphasis
                },
                "hover": {
                    "background": "#f1f3f5",
                    "border": natura_v2_light_controlls.color.primary,
    ...
    "card": {
        ...
        "color": {
            "background": natura_v2_light_controlls.color.surface
        }
    },
    "checkbox": {
        "label": {
    ...
    "dialog": {
        ...
        "color": {
            "background": natura_v2_light_controlls.color.surface,
            "title": natura_v2_light_controlls.color.highlight
        }
    },
    "divider": {
        "color": {
            "background": natura_v2_light_controlls.color.lowEmphasis
        }
    },
    "expansionPanel": {
        "title": {
    ...
    "iconButton": {
        ...
        "overlay": {
            "color": {
                "enable": {
                    "background": natura_v2_light_controlls.color.highlight
                },
                "disable": {
                    "background": natura_v2_light_controlls.color.highlight
                },
    ...
    "link": {
        ...
        "color": {
            "label": {
                "enable": {
                    "default": natura_v2_light_controlls.color.link,
                    "light": natura_v2_light_controlls.color.lowEmphasis
                }
            }
        }
    },
    ...
    "progressIndicator": {
        ...
        "color": {
            "stroke": natura_v2_light_controlls.color.primary,
            "layer": natura_v2_light_controlls.color.surface,
        }
    },
    "radioButton": {
        "label": {
        ...
        "color": {
            "select": {
                "border": natura_v2_light_controlls.color.primary,
                "content": natura_v2_light_controlls.color.primary
            },
            "unselect": {
                "border": natura_v2_light_controlls.color.highlight,
                "content": natura_v2_light_controlls.color.highlight
            },
            "disable": {
                "border": natura_v2_light_controlls.color.lowEmphasis,
                "content": natura_v2_light_controlls.color.lowEmphasis
            }
        }
    },
    "rating": {
            ...
            "color": {
                ...
                "disable": {
                    "primary": {
                        "background": natura_v2_light_controlls.color.highlight,
                        "border": natura_v2_light_controlls.color.lowEmphasis,
                        "label": natura_v2_light_controlls.color.lowEmphasis,
                    },
                    "neutral": {
                        "background": natura_v2_light_controlls.color.highlight,
                        "border": natura_v2_light_controlls.color.lowEmphasis,
                ...
                "hover": {
                    "primary": {
                        "background": "#f1f3f5",
                        "border": natura_v2_light_controlls.color.primaryDark,
                        "label": natura_v2_light_controlls.color.highEmphasis
                    },
                    "neutral": {
                        "background": "#f1f3f5",
                        "border": natura_v2_light_controlls.color.mediumEmphasis,
                        "label": natura_v2_light_controlls.color.highEmphasis
                    }
                },
                "focus": {
    ...
    "tag": {
        ...
        "color": {
            "background": {
                "primary": natura_v2_light_controlls.color.primary,
                "secondary": natura_v2_light_controlls.color.secondary,
                "success": natura_v2_light_controlls.color.success,
                "alert": natura_v2_light_controlls.color.alert,
                "warning": natura_v2_light_controlls.color.warning,
                "link": natura_v2_light_controlls.color.link
            },
            "label": {
                "primary": natura_v2_light_controlls.color.highEmphasis,
                "secondary": natura_v2_light_controlls.color.highlight,
                "success": natura_v2_light_controlls.color.onSuccess,
                "alert": natura_v2_light_controlls.color.onAlert,
                "warning": natura_v2_light_controlls.color.onWarning,
                "link": natura_v2_light_controlls.color.onLink
            }
        }
    },
    "textField": {
    ...
    "typography": {
        ...
        "fontFamily": {
            "primary": natura_v2_light_controlls.typography.fontFamily.primary,
            "secondary": natura_v2_light_controlls.typography.fontFamily.secondary,
            "branding": natura_v2_light_controlls.typography.fontFamily.branding,
            "code": natura_v2_light_controlls.typography.fontFamily.code
        },
        "fontWeight": {
            "regular": 400,
            "medium": 500
        ...
        "display": {
            "fontFamily": natura_v2_light_controlls.typography.display.fontFamily,
            "fontWeight": 700
        },
        "headline": {
            "fontFamily": natura_v2_light_controlls.typography.headline.fontFamily,
            "fontWeight": 500
        },
        "body": {
            "regular": {
                "fontFamily": natura_v2_light_controlls.typography.body.regular.fontFamily,
                "fontWeight": 400
            },
            "bold": {
                "fontFamily": natura_v2_light_controlls.typography.body.bold.fontFamily,
                "fontWeight": 700
            }
        },
        "fallback": {
    ...
    "color": {
        ...
        "neutral900": "#212529",
        "primary": natura_v2_light_controlls.color.primary,
        "onPrimary": natura_v2_light_controlls.color.onPrimary,
        "primaryLight": natura_v2_light_controlls.color.primaryLight,
        "onPrimaryLight": natura_v2_light_controlls.color.onPrimaryLight,
        "primaryLightest": natura_v2_light_controlls.color.primaryLightest,
        "onPrimaryLightest": natura_v2_light_controlls.color.onPrimaryLightest,
        "primaryDark": natura_v2_light_controlls.color.primaryDark,
        "onPrimaryDark": natura_v2_light_controlls.color.onPrimaryDark,
        "primaryDarkest": natura_v2_light_controlls.color.primaryDarkest,
        "onPrimaryDarkest": natura_v2_light_controlls.color.onPrimaryDarkest,
        "secondary": natura_v2_light_controlls.color.secondary,
        "onSecondary": natura_v2_light_controlls.color.onSecondary,
        "secondaryLight": natura_v2_light_controlls.color.secondaryLight,
        "onSecondaryLight": natura_v2_light_controlls.color.onSecondaryLight,
        "secondaryDark": natura_v2_light_controlls.color.secondaryDark,
        "onSecondaryDark": natura_v2_light_controlls.color.onSecondaryDark,
        "secondaryDarkest": natura_v2_light_controlls.color.secondaryDarkest,
        "onSecondaryDarkest": natura_v2_light_controlls.color.onSecondaryDarkest,
        "background": natura_v2_light_controlls.color.background,
        "onBackground": natura_v2_light_controlls.color.onBackground,
        "surface": natura_v2_light_controlls.color.surface,
        "onSurface": natura_v2_light_controlls.color.onSurface,
        "highlight": natura_v2_light_controlls.color.highlight,
        "highEmphasis": natura_v2_light_controlls.color.highEmphasis,
        "mediumEmphasis": natura_v2_light_controlls.color.mediumEmphasis,
        "lowEmphasis": natura_v2_light_controlls.color.lowEmphasis,
        "link": natura_v2_light_controlls.color.link,
        "onLink": natura_v2_light_controlls.color.onLink,
        "success": natura_v2_light_controlls.color.success,
        "onSuccess": natura_v2_light_controlls.color.onSuccess,
        "warning": natura_v2_light_controlls.color.warning,
        "onWarning": natura_v2_light_controlls.color.onWarning,
        "alert": natura_v2_light_controlls.color.alert,
        "onAlert": natura_v2_light_controlls.color.onAlert,
    },
    "asset": {
        "font": {
            "file": {
